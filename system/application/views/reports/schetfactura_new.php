...
<FONT size=7>
 <table width=100%>
 <tr align=center>
 <td width=2100px> <b><?php echo (strlen(trim($akt_vypolnenyh_rabot))==0?"Есеп шот фактура / Счет-фактура":$akt_vypolnenyh_rabot);?> №</b> <?php
if (strlen($schet2)==0){ echo ($schetfactura_date->id);} else {echo $schet2;} echo " от ";
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;}?>
 ...
 <tr><td></td><td></td></tr>
 <tr >
 <td width=2100px> <b>Жеткiзуші <br />Поставщик</b>     <u><?php echo $org->org_name; ?></u>
 </td>
  <td> (2)</td>
 </tr>
 <tr>
 ...
 <tr>
 <td width=2100px>Жүк алушы БСН<br/>Грузополучатель БИН  <u>  <?php echo $firm->bin.", ".$firm->name.", ".$firm->address;?>                                                                                                                 </u>   </td>
 <td> (9)</td>
 </tr>
 <tr align=right>
 ...
 <tr>
 <td width=2100px>Алушының ЖСК<br/> ИИК получателя<u>   <?php echo $firm->raschetnyy_schet;?></u> в банке <u><?php echo $bank->name;?></u> БИК <u><?php echo $firm->bik;?></u></td>
 <td> (10б)</td>
 </tr>
 </table>
 <br>
...
<tr align="center">
	...
	<TD width="400px">Электроэнергия за <br/> <?php echo datetostring2($schetfactura_date->date);?> года </td>
